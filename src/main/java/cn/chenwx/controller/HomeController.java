...
//        this.blogBaseData(request, contentCond);//获取公共分类标签等数据
    ...
    @ApiOperation("文章专栏")
    @GetMapping(value = {"/blog/article","/blog/article/index"})
    public String blogArticle(
        ...
        int limit
            ...
            return this.articleIndex(request, 1, limit);

    }
    @ApiOperation("文章专栏-分页")
    @GetMapping(value = "/article/page/{p}")
