...
layui.use(['element', 'layer', 'util', 'form'], function () {
    ...
    //用户评论tips
    var tips;
    $('.detailMessage').on('mouseover', function () {
...
window._bd_share_config = {
    "common": {
        ...
        "bdStyle": "0",
        "bdSize": "32",
        "bdUrl" : 'http://www.apenixx.top',//分享的地址
        "bdDesc":'兄弟，有福利哦，赶紧来看看~',
        "bdPic" : "https://apenixx-oss.oss-cn-shenzhen.aliyuncs.com/public/BlogInfo/avater2.jpg",//分享的图像地址
    },
    "share": {}
};
