    ...
    var events = {
        ...
        , reword: function () {
            layer.tab({
                ...
                tab: [{
                    title: '微信',
                    content: '<img style="width:330px;height:330px;" src="/others/static/images/zhifubao.png" />'
                }, {
                    title: '支付宝',
                    content: '<img style="width:330px;height:330px;" src="/others/static/images/Qweixin.png" />'
                }]
            });
